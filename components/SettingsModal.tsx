...
import { Settings, Moon, Sun, Save, X } from 'lucide-react';
    ...
    <div className="fixed inset-0 bg-slate-900/70 backdrop-blur-sm z-50 flex items-center justify-center p-4">
      <div className="bg-white dark:bg-slate-800 rounded-xl shadow-2xl w-full max-w-lg flex flex-col overflow-hidden border border-slate-200 dark:border-slate-700">
        ...
        <form onSubmit={handleSubmit} className="flex-1 overflow-y-auto p-6 space-y-6">
          ...
          {/* Appearance */}
          <div>
            <h4 className="text-xs font-bold text-slate-500 dark:text-slate-400 uppercase tracking-wider mb-3">Appearance</h4>
            <div className="flex items-center justify-between p-3 bg-slate-50 dark:bg-slate-900 rounded-lg border border-slate-200 dark:border-slate-700">
              ...
              >
                ...
                <span className="text-xs font-bold uppercase">{formData.theme}</span>
              </button>
            </div>
          </div>
          ...
          {/* Connection Defaults */}
          <div>
            <h4 className="text-xs font-bold text-slate-500 dark:text-slate-400 uppercase tracking-wider mb-3">Default Connection Details</h4>
            <div className="grid grid-cols-2 gap-4">
              <div className="col-span-2">
                <label className="block text-xs text-slate-500 dark:text-slate-400 mb-1">Default Host</label>
                <input 
                  type="text" 
              ...
              <div>
                <label className="block text-xs text-slate-500 dark:text-slate-400 mb-1">Default User</label>
                <input 
                  type="text" 
              ...
              <div>
                <label className="block text-xs text-slate-500 dark:text-slate-400 mb-1">Default Port</label>
                <input 
                  type="text" 
              ...
              <div className="col-span-2">
                <label className="block text-xs text-slate-500 dark:text-slate-400 mb-1">Default Database Name</label>
                <input 
                  type="text" 
          ...
          {/* Query & AI Defaults */}
          <div>
            <h4 className="text-xs font-bold text-slate-500 dark:text-slate-400 uppercase tracking-wider mb-3">Query & AI Preferences</h4>
            <div className="space-y-3">
              <div>
                <label className="block text-xs text-slate-500 dark:text-slate-400 mb-1">Default Row Limit</label>
                <input 
                  type="number" 
              ...
              <div className="flex items-center justify-between">
                <div className="flex flex-col">
                  <span className="text-sm font-medium text-slate-700 dark:text-slate-300">Enable AI Validation</span>
                  <span className="text-[10px] text-slate-500 dark:text-slate-500">Check SQL syntax for errors automatically</span>
                </div>
              ...
              <div className="flex items-center justify-between">
                 <div className="flex flex-col">
                   <span className="text-sm font-medium text-slate-700 dark:text-slate-300">Enable AI Tips</span>
                   <span className="text-[10px] text-slate-500 dark:text-slate-500">Generate optimization suggestions</span>
                 </div>
                 <label className="relative inline-flex items-center cursor-pointer">
                   <input 
                     type="checkbox" 
